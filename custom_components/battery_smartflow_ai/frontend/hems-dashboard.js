    ...
    return `
      <section class="section"><div class="section-head"><h2>${this._escape(this._t("price_context"))}</h2><small>${this._escape(this._t("daily_costs"))}</small></div>
        <div class="reading-grid">
          ...
          ${this._reading(entities, this._t("pv_credit"), [["pv forecast credited to the charge plan"]])}
          ${this._reading(entities, this._t("peak_coverage"), [["end of planned peak coverage"]])}
        </div>
      </section>
